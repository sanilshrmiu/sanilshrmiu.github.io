...
document.getElementById("run-function").onclick = runThese;

function runThese() {
  console.log("Fix using wrapper");
  function askPassword1(ok, fail) {
    let password = prompt("(Question 1 using wrapper) Password?", "");
  ...
  function askPassword2(ok, fail) {
    let password = prompt("(Question 1 using bind) Password?", "");
    if (password == "rockstar") ok();
    else fail();
  }
  ...
  function askPassword3(ok, fail) {
    let password = prompt("(Question 1 using apply) Password?", "");
  ...
  function askPassword4(ok, fail) {
    let password = prompt("(Question 1 using call) Password?", "");
